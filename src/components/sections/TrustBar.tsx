...
const AnimatedCounter = ({ item }: { item: TrustItem }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group flex flex-col items-center gap-2 sm:gap-2.5 md:gap-3 rounded-xl bg-white border border-border-light p-4 sm:p-5 md:p-6 lg:p-8 shadow-sm transition-all hover:border-brand-primary/20 hover:shadow-[0_8px_40px_rgba(11,95,165,0.06)]"
    >
...
const TrustBar = () => {
  return (
    <section className="section-spacing bg-bg-secondary border-b border-border-light">
      <div className="container-custom">
        ...
        >
          <span className="text-[10px] sm:text-xs font-medium uppercase tracking-widest text-brand-primary/70">
            Vertrauen & Qualität
          </span>
          ...
          <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-text-body/40">
        ...
        >
          ...
          <span className="text-[10px] sm:text-xs uppercase tracking-widest text-text-body/20">
            Geprüfte Qualität
          </span>
          <span className="h-px w-8 sm:w-10 md:w-12 bg-border-light" />
        </motion.div>
