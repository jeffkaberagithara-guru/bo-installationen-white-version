      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="text-[9px] sm:text-[10px] md:text-xs font-medium uppercase tracking-widest text-cta-orange">
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 rounded-xl bg-white border border-border-light px-3 sm:px-4 py-2 sm:py-3 shadow-sm transition-all duration-150 hover:border-cta-orange/30 hover:shadow-[0_4px_16px_rgba(242,153,74,0.06)]">
              ...
              <div>
                <div className="text-xs sm:text-sm font-semibold text-text-heading">
                  Reaktionszeit
                </div>
                <div className="text-[10px] sm:text-xs text-text-body/40">
                  &lt; 20 Minuten
                </div>
              </div>
            </div>
          ...
          >
            <h4 className="mb-2 sm:mb-3 flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold text-text-heading">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-6 sm:mt-7 md:mt-8 flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-[10px] sm:text-xs text-text-body/30"
          >
            <span className="flex items-center gap-1.5 sm:gap-2">
              <Shield className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand-primary/60" />
              Zertifiziert
            </span>
            <span className="h-3 w-px bg-border-light" />
            <span className="flex items-center gap-1.5 sm:gap-2">
              <Clock className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand-primary/60" />
              24/7 Erreichbar
            </span>
            <span className="h-3 w-px bg-border-light" />
            <span className="flex items-center gap-1.5 sm:gap-2">
              <CheckCircle className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-brand-primary/60" />
              Festpreisgarantie
            </span>
          </motion.div>
        </div>
