  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="block text-text-heading">PRÄZISION</span>
        ...
        <motion.p
          ...
          className="mt-3 sm:mt-4 md:mt-6 max-w-xl sm:max-w-2xl text-sm sm:text-base md:text-lg lg:text-xl text-text-body"
        >
        ...
        >
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-1.5 sm:gap-2 md:gap-3 rounded-xl bg-white border border-border-light px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 shadow-sm"
            >
        ...
        >
          ...
          <button
            ...
            className="btn-secondary text-base px-8 sm:px-10 py-3.5 sm:py-4"
          >
